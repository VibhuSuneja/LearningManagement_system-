  ...
  return (
    <div className='min-h-screen bg-gray-100 flex items-center justify-center p-4'>
        ...
        <div className='w-full max-w-xl bg-white rounded-xl shadow-lg p-6 space-y-6'>
            ...
            <button className='mt-2 px-4 py-2 bg-red-600 text-white 
            rounded-md hover:bg-red-700 transition-all text-sm' disabled={loading1} onClick={removeLecture}>{loading1?<ClipLoader size={30} color='white'/>:"Remove Lecture"}</button>
            ...
            <div className='space-y-4'>
              ...
              <div className='pt-4'>
                <button className='w-full bg-black text-white py-3 rounded-md text-sm font-medium hover:bg-gray-700 transition' disabled={loading} onClick={handleEditLecture}>
                  {loading?<ClipLoader size={30} color='white'/>:"Update Lectures"}
                </button>
              </div>
