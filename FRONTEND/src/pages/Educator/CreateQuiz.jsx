...
function CreateQuiz() {
  ...
  const handleAiGenerate = async () => {
    ...
    console.log('[DEBUG - AI Generate] Starting quiz generation with:', {
      courseId,
      lectureContentLength: lectureContent.length,
    ...
    try {
      ...
      console.log('[DEBUG - AI Generate] Result:', result.data);
      ...
      console.error('[DEBUG - AI Generate] Error Details:', error.response?.data);
