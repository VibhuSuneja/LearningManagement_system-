          ...
          <tbody>
            ...
            <tr key={index}className='border-b hover:bg-gray-50 transition duration-200'>
              ...
              <td className='py-3 px-4 flex gap-3'> 
                ...
                <FaEye className='text-gray-600 hover:text-blue-500 cursor-pointer' onClick={() => navigate(`/viewlecture/${course?._id}`)} title="View Course Content" />
                ...
                <FaGraduationCap className='text-gray-600 hover:text-orange-600 cursor-pointer' onClick={() => navigate(`/create-assignment/${course._id}`)} title="Create Assignment" />
                <FaTasks className='text-gray-600 hover:text-indigo-600 cursor-pointer' onClick={() => navigate(`/manage-assignments/${course._id}`)} title="Manage Assignments" />
              </td>
            </tr>
            ))}
          </tbody>
