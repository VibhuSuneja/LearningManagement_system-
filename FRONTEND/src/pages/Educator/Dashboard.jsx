    ...
    <div className='flex min-h-screen bg-gray-100'>
      ...
      <div className='w-full px-6 py-10 bg-gray-50 space-y-10'>
        ...
        <div className='max-w-5xl mx-auto bg-white 
          rounded-xl shadow-md p-6 flex flex-col md:flex-row items-center
          gap-6'
        >
          {userData?.photoUrl ? (
            <img
            ...
            <div className='w-28 h-28 rounded-full border-4 border-black shadow-md 
              flex items-center justify-center bg-black text-3xl font-bold text-white'>
          ...
          <div className='text-center md:text-left space-y-1'>
            ...
            <h1
              ...
              py-[10px] border-2 bg-black border-black
