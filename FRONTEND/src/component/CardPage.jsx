...
useEffect(() => {
  if (Array.isArray(courseData)) {
    ...
    setPopularCourses([]) // safe fallback
  }
}, [courseData])
  ...
  return (
    <div className='relative flex items-center justify-center flex-col'>
        ...
        <span className='lg:w-[50%] md:w-[80%] text-[15px] text-center mt-[30px] mb-[30px] px-[20px]'>Explore top-rated courses designed to boost your skills
            , enhance careers, and unlock opportunities in tech, 
            AI, business, and beyond.</span>
            <div className='w-[100%] min-[100vh] flex items-center justify-center
